...
//  - assets/js/sepay-checkout.js gọi window.sngGetCtvCode() để đính kèm mã này
//    vào đơn hàng khi khách thanh toán -> tính hoa hồng cho đúng CTV.
//
// Không cần supabase-js, gọi thẳng REST API (giống assets/js/track-visit.js)
// để không phụ thuộc thứ tự load script và không chặn/làm chậm trang.
// ============================================================
(function () {
    var SUPABASE_URL = window.SNG_SUPABASE_URL;
    var SUPABASE_ANON_KEY = window.SNG_SUPABASE_ANON_KEY;
